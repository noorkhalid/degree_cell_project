...
urlpatterns = [
    ...
    path('fees/import/', views.fee_structure_import, name='fee_structure_import'),
    path('fees/export/', views.fee_structure_export, name='fee_structure_export'),
    path('fees/template/', views.fee_structure_template, name='fee_structure_template'),
    path('fees/bulk-delete/', views.fee_structure_bulk_delete, name='fee_structure_bulk_delete'),
    path('fees/bulk-archive/', views.fee_structure_bulk_archive, name='fee_structure_bulk_archive'),
